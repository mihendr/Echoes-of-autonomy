...
backup_client = OpenAI(
    api_key="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",
    base_url="https://api.groq.com/openai/v1"
)

client = OpenAI(
    api_key="7705e9b996faa95ebc0ca93d1dc9da26d7828a209a28dc90c513ca57df8b4002",
...
# User input
initial_sentence = input("Initial phrase: ")

rules_type = int(input("""
